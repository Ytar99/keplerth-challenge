...
var hljs = (function () {
      ...
      function f(e, t, i, r) {
        ...
        function c() {
          ...
          for (; n; ) {
            ...
            if (r) {
              const [e, a] = r;
              if ((S.addText(t), (t = ""), (l[i] = (l[i] || 0) + 1), l[i] <= 7 && (C += a), e.startsWith("_")))
                t += n[0];
              else {
        ...
        function b(e, n) {
          return (
            e.scope && "string" == typeof e.scope && S.openNode(w.classNameAliases[e.scope] || e.scope),
            e.beginScope &&
              (e.beginScope._wrap
        ...
        function N(a, r) {
          ...
          if (((y = r), "begin" === r.type))
            return ((e) => {
              ...
              return (
                a.skip ? (A += t) : (a.excludeBegin && (A += t), d(), a.returnBegin || a.excludeBegin || (A = t)),
                b(a, e),
        ...
        try {
          ...
          return (
            S.finalize(), (k = S.toHTML()), { language: e, value: k, relevance: C, illegal: !1, _emitter: S, _top: x }
          );
        } catch (n) {
  ...
  function Oe(e) {
    ...
    const _ = [].concat(m, c.contains),
      ...
      f = { className: "params", begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: i, contains: h },
      E = {
        variants: [
          {
  ...
  var Ke = Object.freeze({
    ...
    grmr_c: (e) => {
      const n = e.regex,
        ...
        m = {
          ...
          keywords: u,
          contains: b.concat([{ begin: /\(/, end: /\)/, keywords: u, contains: b.concat(["self"]), relevance: 0 }]),
          relevance: 0,
        },
        p = {
          begin: "(" + r + "[\\*&\\s]+)+" + g,
    ...
    grmr_cpp: (e) => {
      const n = e.regex,
        ...
        p = {
          ...
          keywords: u,
          contains: m.concat([{ begin: /\(/, end: /\)/, keywords: u, contains: m.concat(["self"]), relevance: 0 }]),
          relevance: 0,
        },
        _ = {
          className: "function",
    ...
    grmr_less: (e) => {
      ...
      const g = s.concat({
        ...
        u = { beginKeywords: "when", endsWithParent: !0, contains: [{ beginKeywords: "and not" }].concat(s) },
        b = {
          begin: i + "\\s*:",
          returnBegin: !0,
          end: /[;}]/,
      ...
      return (
        r.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, m, p, h, b, _, u, n.FUNCTION_DISPATCH),
    ...
    grmr_swift: (e) => {
      const n = { match: /\s+/, relevance: 0 },
        ...
        k = [e.BACKSLASH_ESCAPE, { begin: /\[/, end: /\]/, relevance: 0, contains: [e.BACKSLASH_ESCAPE] }],
        x = { begin: /\/[^\s](?=[^/\n]*\/)/, end: /\//, contains: k },
        M = (e) => {
          const n = b(e, /\//),
            t = b(/\//, e);
          return { begin: n, end: t, contains: [...k, { scope: "comment", begin: `#(?!.*${t})`, end: /$/ }] };
        },
        S = {
          scope: "regexp",
          variants: [M("###"), M("##"), M("#"), x],
        ...
        A = { match: b(/`/, Fe, /`/) },
        C = [A, { className: "variable", match: /\$\d+/ }, { className: "variable", match: `\\$${ze}+` }],
        T = [
          {
            match: /(@|#(un)?)available/,
            scope: "keyword",
        ...
        R = {
          ...
          relevance: 0,
          contains: [
            { className: "type", match: b(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/, ze, "+") },
    ...
    grmr_yaml: (e) => {
      const n = "true false yes no null",
        ...
        c = [...l];
      return (
        c.pop(), c.push(i), (r.contains = c), { name: "YAML", case_insensitive: !0, aliases: ["yml"], contains: l }
      );
    },
  });
  const He = ae;
